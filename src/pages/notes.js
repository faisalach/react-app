									...
									<div className=" px-6 py-3">
										...
										<div className="relative mb-3 shadow rounded-lg overflow-x-auto mt-5">
											<table className="w-full text-left rtl:text-right text-gray-500 dark:text-gray-400">
												...
												<tbody>
													{
														maintenance.detail_maintenance.map(detail_maintenance => {
															return (
																<tr key={"d_"+detail_maintenance.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
																	<td className="px-6 py-4 border border-gray-200 font-medium text-gray-900 whitespace-nowrap dark:text-white">
																		{detail_maintenance.title}
																	</td>
																	<td className="px-6 py-4 border border-gray-200">
																		{moneyFormat(detail_maintenance.price)}
																	</td>
																</tr>
															)
														})
