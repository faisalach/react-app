    ...
    return (
        <div className="grid sm:grid-cols-12">
            ...
            <div className='md:col-span-4 sm:col-span-6 sm:min-h-screen sm:p-10 p-7'>
                <h1 className="md:text-5xl text-2xl md:mb-7 mb-5 sm:mt-5">Welcome <br/> Back</h1>
                ...
                <div className="md:mt-10 mt-5">
                    <form onSubmit={ submit }>
                        ...
                        <div className="d-grid gap-2 mt-5">
                            <p className="text-gray-500 text-center">Create new account? <a href="/register" className='text-blue-700 hover:text-blue-500'>Register</a></p>
