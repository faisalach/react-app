...
const Navbar = ({children,page,title}) => {
    ...
    return (
        <>
            ...
            <div className="p-4 sm:ml-64 sm:mt-0 mt-[64px] bg-gray-50 min-h-screen">
                {
                    title && (
            ...
            <div className="h-15 bg-white border-t-2 fixed bottom-0 left-64 right-0 border-gray-200 flex items-center">
